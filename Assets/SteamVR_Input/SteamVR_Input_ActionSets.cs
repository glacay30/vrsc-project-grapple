...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_object_manipulation p_object_manipulation;
        ...
        public static SteamVR_Input_ActionSet_object_manipulation object_manipulation
        {
            get
            {
                return SteamVR_Actions.p_object_manipulation.GetCopy<SteamVR_Input_ActionSet_object_manipulation>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_object_manipulation = ((SteamVR_Input_ActionSet_object_manipulation)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_object_manipulation>("/actions/object_manipulation")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.object_manipulation};
        }
    }
}
